...
<body>
    <header>
        ...
        <div class="jumbotron">
            <div class="container">
                ...
                <p class="lead">Here are all your favorite recipes.</p>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="side-panel" id="sidePanel">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a href="/#">Favorites</a></li>
            ...
            <div class="col-md-8">
                <div class="row">
				<c:forEach items="${likedRecipes}" var="recipe">
				    <div class="col-md-6">
				        <div class="card">
				            <!-- Recipe image -->
				            ...
				            <div class="card-body">
				                ...
				                <c:choose>
				                    <c:when test="${liked}">
				                        <a href="/recipe/unlike/${recipe.id }"><button class="btn btn-dark mt-3" data-bs-toggle="modal" data-bs-target="#rateModal1">Unlike</button></a>  <a href="/recipe/rates/${recipe.id }"><button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#rateModal1">Rate</button></a>
				                    </c:when>
				                    <c:otherwise>
				                        <a href="/recipe/like/${recipe.id }"><button class="btn btn-dark mt-3" data-bs-toggle="modal" data-bs-target="#rateModal1">Like</button></a>  <a href="/recipe/rates/${recipe.id }"><button class="btn btn-primary mt-3" data-bs-toggle="modal" data-bs-target="#rateModal1">Rate</button></a>
				                    </c:otherwise>
				                </c:choose>
				            </div>
				        </div>
